...
If you want to try changes before they're properly released, you can simply download the repository and copy the "modpack" folder (might want to rename it to vsexpanded so you know what it is) into your "Mods" folder (which can be found via the "Open Mods Folder" button on the Mod Manager screen in the main menu).